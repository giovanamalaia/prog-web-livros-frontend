...
async function carregarPerfil(): Promise<void> {
  ...
  if (dados.foto_perfil_url) (document.getElementById('fotoPerfil') as HTMLElement).outerHTML = `<img src="${html(dados.foto_perfil_url)}" class="profile-large-avatar" id="fotoPerfil" alt="${html(nome)}">`;
